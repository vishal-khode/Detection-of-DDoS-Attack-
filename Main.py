...
def graph():
    ...
    output+="<tr><td>AdaBoostBoost Algorithm</td><td>"+str(accuracy[3])+"</td><td>"+str(precision[3])+"</td><td>"+str(recall[3])+"</td><td>"+str(fscore[3])+"</td></tr>"
    output+="<tr><td>KNN Algorithm</td><td>"+str(accuracy[4])+"</td><td>"+str(precision[4])+"</td><td>"+str(recall[4])+"</td><td>"+str(fscore[4])+"</td></tr>"
...
font = ('times', 16, 'bold')
title = Label(main, text='Mitigating Distributed Denial of Service Attack')
title.config(bg='orange', fg='Black')  
title.config(font=font)           
title.config(height=4, width=135)       
title.place(x=0,y=5)
...
knnButton.place(x=630,y=600)
knnButton.config(font=font1)

graphButton = Button(main, text="Comparison Graph", command=graph)
graphButton.place(x=920,y=600)
